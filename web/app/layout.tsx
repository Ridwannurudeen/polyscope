...
export const metadata: Metadata = {
  metadataBase: new URL("https://polyscope.gudman.xyz"),
  title: "PolyScope - Accuracy terminal for Polymarket",
  description:
    "Live divergence scanner, trader accuracy leaderboard, and evidence-backed decision cards for Polymarket. We measure who's actually predictive, not just profitable.",
  openGraph: {
    title: "PolyScope - Accuracy terminal for Polymarket",
    description:
      "Live divergence scanner, trader accuracy leaderboard, and evidence-backed decision cards for Polymarket.",
